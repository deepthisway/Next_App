    ...
    <div className="absolute bg-white w-full max-w-[1650px] h-auto top-[90px] left-[50%] transform -translate-x-1/2 rounded-[10px]  border-gray-300 shadow-md z-20 p-6">
      <div className="flex flex-col md:flex-row mx-5 md:mx-10 mt-5 space-y-10 md:space-y-0 md:space-x-10 lg:space-x-28">
        <div className="md:w-[500px] relative">
          <p className="flex justify-center mb-2 text-blue-400 text-xl md:text-xl">#Ranked in Top 10 Teachers</p>
          <img
  alt="Teacher"
...
/>
          ...
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="gray" className="size-5 mt-1">
          ...
          <div className="flex flex-col gap-4">
            <div className="flex justify-between">
              <div className="flex">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill='#BDBDBD' className="size-5 mt-0.5 mr-1">
            ...
            <div className="flex justify-between">
              <div className="flex">
              <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="24" height="24" viewBox="0 0 48 48" className='size-5 mt-0.5 mr-1' >
